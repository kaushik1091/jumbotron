...
<body style="background-color:grey;">
    ...
    <center>
        <br/><br/><br/><br/><br/>
        <p>
            <form role="form" action="includes/joinfun.php" method="post" name="create_class">
                <div class="well" style="max-width: 400px; margin: 0 auto 10px;">
            
                <h3><span class="text-muted">Enter the class code<br/></h3></span>
            
                <!-- <input type="text" name="class_name" placeholder="        Class Name  "> -->
                <div class="form-group">
                  <input type="text" placeholder="Class ID" name="class_id" class="form-control">
                ...
                <button class="btn btn-primary btn-lg btn-block" type="submit">Proceed to Class</button>
