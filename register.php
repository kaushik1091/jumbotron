...
<html>
  <head>
    <title>Jumbotron - User Registration</title>
    ...
    <body>
      ...
      <form class="form-horizontal" role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" 
		...
		<div class="form-group">
			<label for="user_id"  class="col-sm-2 control-label">E-Mail</label>
			<div class="col-sm-10">
			<input type="email" class="form-control" placeholder="Your E-Mail ID" name='user_id' id='user_id' required>
			</div>
		</div>
